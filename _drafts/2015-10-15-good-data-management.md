...
Big business takes data management seriously, funnelling millions (of what?) into its efficient curation and mining.  Geoffrey Moore noted 'Without big data analytics, companies are blind and deaf, wandering out onto the Web like deer on a freeway.' (Needs verification, where is this quote from?) But how does good data management apply to academia and science in general? Scientists work with data on a daily basis, but is it managed in a way that maximizes its potential? That depends on what you mean by 'good' data management.
